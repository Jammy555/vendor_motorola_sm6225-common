...
PRODUCT_COPY_FILES += \
    ...
    vendor/motorola/sm6225-common/proprietary/vendor/etc/seccomp_policy/mediacod/libqti-util.soec.policy:$(TARGET_COPY_OUT_VENDOR)/etc/seccomp_policy/mediacodec.policy \
